...
export default function Contact() {
  return (
    <m.div
      ...
      exit={{ opacity: 1 }}
      className="text-gray-900 absolute top-0 left-0 w-full h-full bg-red-400 lg:px-48 px-8"
    >
      <Header />
      <main>
        ...
        <div className="flex justify-between">
          ...
          <div className="lg:text-2xl md:text-xl text-base text-right underline">
